...
getDataFromRedisNodeFinder() {
    ...
    cd /scripts && ./redis-node-finder run --master-file="$master_file_name" --slave-file="$slave_file_name" --nodes-file="$redis_nodes_file_name" --initial-master-file="$initial_master_nodes_file_name"
